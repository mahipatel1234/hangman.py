### This code displays a Python version of the classic-word guessing game, Hangman. The object of the game is to guess letters until the secret word has been correctly guessed. The player has 6 attempts before the full body of the man is hung.

### Imports random module, which includes random number generation-related functions.
import random

### Contains keyboard art strings, representing different stages of the Hangman.
hangman1 = [
"""
+---+
    |
...
### Tells the program to select a random word from the (colors) list, and is then converted to lowercase letters.
...
### Defines number of attempts allowed and subtracts 1 atempt after each attempt. 
tries = 6
hangman_count = -1
...
### If-else statements determine the correctness of the guessed letters.
while tries > 0:
    output = ''
    for letter in word:
